-- ============================================
-- SEEDS: DATOS DE PRUEBA - VERSIÓN FINAL CORREGIDA
-- ============================================

BEGIN;

-- Deshabilitar constraints temporalmente para datos históricos
...
-- ADMINISTRADOR
WITH new_admin AS (
    INSERT INTO usuario (nombre, apellidos, dni, email, telefono, password, rol, activo)
    VALUES ('Carlos', 'Administrador López', '12345678A', 'admin@clinica.com', '666111222',
            '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO', 'ADMIN'::rol_usuario, true)
    RETURNING id
)
INSERT INTO administrador (usuario_id, nivel_acceso, departamento)
SELECT id, 3, 'Dirección General' FROM new_admin;
...
('María', 'García Sánchez', '23456789B', 'recepcion@clinica.com', '666222333',
 '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO', 'RECEPCIONISTA'::rol_usuario, true),
...
('Dr. Antonio', 'Ruiz Fernández', '45678901D', 'antonio.ruiz@clinica.com', '666444555',
 '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO', 'FISIOTERAPEUTA'::rol_usuario, true),
...
-- CLIENTES
INSERT INTO usuario (nombre, apellidos, dni, email, telefono, password, rol, activo) VALUES
('Juan', 'Pérez Gómez', '11111111A', 'juan.perez@gmail.com', '611111111', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Ana', 'Rodríguez López', '22222222B', 'ana.rodriguez@gmail.com', '622222222', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Pedro', 'Sánchez Martín', '33333333C', 'pedro.sanchez@hotmail.com', '633333333', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Isabel', 'García Fernández', '44444444D', 'isabel.garcia@outlook.com', '644444444', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Luis', 'Martínez Ruiz', '55555555E', 'luis.martinez@yahoo.es', '655555555', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Sofía', 'Hernández Torres', '66666666F', 'sofia.hernandez@gmail.com', '666666666', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('David', 'López Jiménez', '77777777G', 'david.lopez@gmail.com', '677777777', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Marta', 'Díaz Moreno', '88888888H', 'marta.diaz@hotmail.com', '688888888', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Raúl', 'Torres Silva', '99999999I', 'raul.torres@gmail.com', '699999999', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true),
('Eva', 'Romero Castro', '00000000J', 'eva.romero@outlook.com', '600000000', '$2a$10$XQz9Z8XO/KVhT9xJ0wQ5/.YmGvF7YZ4Z9Q0J5wQ5XQz9Z8XO','CLIENTE'::rol_usuario, true);
...
SELECT 
    ...
    CURRENT_DATE - 5, '12:00'::time, '13:00'::time, 'COMPLETADA'::estado_cita, 55.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE - 3, '16:00'::time, '16:45'::time, 'COMPLETADA'::estado_cita, 50.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 2, '09:00'::time, '09:45'::time, 'PENDIENTE'::estado_cita, 50.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
CROSS JOIN (SELECT ft.usuario_id FROM usuario u JOIN fisioterapeuta ft ON ft.usuario_id = u.id WHERE u.email = 'antonio.ruiz@clinica.com') f
CROSS JOIN (SELECT id FROM servicio WHERE nombre = 'Rehabilitación Deportiva') s
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 2, '11:00'::time, '12:00'::time, 'PENDIENTE'::estado_cita, 60.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
CROSS JOIN (SELECT ft.usuario_id FROM usuario u JOIN fisioterapeuta ft ON ft.usuario_id = u.id WHERE u.email = 'elena.jimenez@clinica.com') f
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 3, '10:00'::time, '10:45'::time, 'PENDIENTE'::estado_cita, 40.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 3, '15:00'::time, '15:30'::time, 'PENDIENTE'::estado_cita, 35.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 5, '16:00'::time, '17:00'::time, 'PENDIENTE'::estado_cita, 45.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
CROSS JOIN (SELECT ft.usuario_id FROM usuario u JOIN fisioterapeuta ft ON ft.usuario_id = u.id WHERE u.email = 'antonio.ruiz@clinica.com') f
CROSS JOIN (SELECT id FROM servicio WHERE nombre = 'Masaje Terapéutico') s
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 7, '09:30'::time, '10:30'::time, 'PENDIENTE'::estado_cita, 55.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
CROSS JOIN (SELECT ft.usuario_id FROM usuario u JOIN fisioterapeuta ft ON ft.usuario_id = u.id WHERE u.email = 'miguel.hernandez@clinica.com') f
CROSS JOIN (SELECT id FROM servicio WHERE nombre = 'Fisioterapia Traumatológica') s
...
SELECT 
    cl.usuario_id, f.usuario_id, s.id, sl.id,
    CURRENT_DATE + 7, '12:00'::time, '13:00'::time, 'PENDIENTE'::estado_cita, 60.00
FROM usuario uc 
JOIN cliente cl ON cl.usuario_id = uc.id
CROSS JOIN (SELECT ft.usuario_id FROM usuario u JOIN fisioterapeuta ft ON ft.usuario_id = u.id WHERE u.email = 'elena.jimenez@clinica.com') f
CROSS JOIN (SELECT id FROM servicio WHERE nombre = 'Osteopatía') s
...
(NULL, 
 ...
 CURRENT_TIMESTAMP + INTERVAL '31 days',  -- +1 día más para cumplir el constraint
